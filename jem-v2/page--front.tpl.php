...
<div class="container">
	<div class="grid home-hero">
		<div class="col16 home-hero-wrapper">
			<?php
			 print render($content['field_carousel_image_1']); 
			?>
			<?php print $heroimage; ?> <!-- Needs class "home-hero-img"> --> 
			<a class="home-hero-cover" href="<?php print $homeherolink; ?>">
				<h2 class="home-hero-header"><?php print $homeherotitle; ?></h2>
				<p><?php print $homeherotext; ?></p>
			</a>
		</div>
				...
				<div class="portal panes">
					<div class="tabs-1 pane">
						...
						<div class="portal-section">
							...
							be in touch!</p><!-- replace with ajax form -->
						...
						<section class="slider home-stories-slider">
							<div class="flexslider">
								<ul class="slides home-stories-slider-thumbs">
								    ...
								    $stories .= "/functions/homepage-stories.php";
